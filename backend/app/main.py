...
async def get_pdf_file(filename: str):
    """Serve uploaded PDF files for Adobe PDF Embed API with proper CORS headers"""
...
async def get_audio(filename: str):
    ...
    audio_path = Path("data/temp_audio") / filename
    ...
    demo_audio_path = Path("data/audio") / filename
